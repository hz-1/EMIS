...
from efficientvit.efficientvit.models.efficientvit import (
    EfficientViTSam,
    efficientvit_sam_l0,
    efficientvit_sam_l1,
    efficientvit_sam_l2,
...
from efficientvit.efficientvit.models.nn.norm import set_norm_eps
from efficientvit.efficientvit.models.utils import load_state_dict_from_file
...
def create_sam_model(name: str, pretrained=True, weight_url = None, **kwargs) -> EfficientViTSam:
    model_dict = {
