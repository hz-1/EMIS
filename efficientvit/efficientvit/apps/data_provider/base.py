...
from efficientvit.efficientvit.apps.data_provider.random_resolution import RRSController
from efficientvit.efficientvit.models.utils import val2tuple
...
class DataProvider:
    ...
    def build_dataloader(self, dataset, batch_size: int, n_worker: int, drop_last: bool, train: bool):
        if dataset is None:
            return None
    ...
    def assign_active_image_size(self, new_size) -> None:
