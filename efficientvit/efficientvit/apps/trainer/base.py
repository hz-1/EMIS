...
from efficientvit.efficientvit.apps.data_provider import DataProvider, parse_image_size
from efficientvit.efficientvit.apps.trainer.run_config import RunConfig
from efficientvit.efficientvit.apps.utils import EMA, dist_barrier, get_dist_local_rank, is_master
from efficientvit.efficientvit.models.nn.norm import reset_bn
from efficientvit.efficientvit.models.utils import is_parallel, load_state_dict_from_file
...
class Trainer:
    ...
    def prep_for_training(self, run_config: RunConfig, ema_decay= None, amp="fp32") -> None:
