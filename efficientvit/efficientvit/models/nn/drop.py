...
from efficientvit.efficientvit.apps.trainer.run_config import Scheduler
from efficientvit.efficientvit.models.nn.ops import IdentityLayer, ResidualBlock
from efficientvit.efficientvit.models.utils import build_kwargs_from_config

__all__ = ["apply_drop_func"]


def apply_drop_func(network: nn.Module, drop_config) -> None:
