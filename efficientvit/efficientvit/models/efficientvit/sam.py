...
from efficientvit.efficientvit.models.efficientvit.backbone import EfficientViTBackbone, EfficientViTLargeBackbone
from efficientvit.efficientvit.models.nn import (
    ConvLayer,
    DAGBlock,
    FusedMBConv,
    IdentityLayer,
...
from efficientvit.efficientvit.models.utils import build_kwargs_from_config, get_device
...
class EfficientViTSamImageEncoder(nn.Module):
    def __init__(self, backbone, neck: SamNeck):
        super().__init__()
...
def efficientvit_sam_l0(image_size: int = 512, **kwargs) -> EfficientViTSam:
    from efficientvit.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l0
...
def efficientvit_sam_xl0(image_size: int = 1024, **kwargs) -> EfficientViTSam:
    from efficientvit.efficientvit.models.efficientvit.backbone import EfficientViTLargeBackbone
