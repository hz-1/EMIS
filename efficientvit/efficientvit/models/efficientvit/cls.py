...
from efficientvit.efficientvit.models.nn import ConvLayer, LinearLayer, OpSequential
from efficientvit.efficientvit.models.utils import build_kwargs_from_config
...
class EfficientViTCls(nn.Module):
    def __init__(self, backbone, head: ClsHead) -> None:
        super().__init__()
